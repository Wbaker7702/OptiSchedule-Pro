...
import { ShieldCheck, Lock, Mail, ArrowRight, Activity, Database, ShieldAlert, Ban } from 'lucide-react';
...
const Login: React.FC<LoginProps> = ({ onLogin, isSuspended }) => {
        ...
        <div className="p-8">
          {isSuspended ? (
            <div className="text-center py-6 space-y-4">
              ...
              <h2 className="text-lg font-bold text-white uppercase tracking-wider">Access Suspended</h2>
              <p className="text-xs text-slate-500 font-mono uppercase tracking-widest leading-relaxed">
                System is currently in suspension mode. Employee login is disabled by management directive.
              </p>
            </div>
          ) : (
            <>
